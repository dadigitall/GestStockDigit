<div>
    ...
    @if($showDetail && $detail)
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div class="flex items-center gap-2 mt-6 pt-4 border-t border-gray-200 dark:border-gray-700" @if($syncingToEmecf) wire:poll.3s="checkEmecfSyncStatus" @endif>
                ...
                @endif
                @if($syncingToEmecf)
                    <span class="inline-flex items-center gap-2 px-3 py-1.5 text-sm font-medium text-amber-600 dark:text-amber-400 bg-amber-50 dark:bg-amber-900/30 rounded-lg animate-pulse">
                        <svg class="w-4 h-4 animate-spin" fill="none" viewBox="0 0 24 24">
                            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                        </svg>
                        Synchronisation e-MECeF en cours...
                    </span>
                @elseif(!$detail->isEmecfSynced() && $detail->sale_id)
